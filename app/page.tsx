      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-8 h-screen -mt-20 grid lg:grid-cols-[1fr_400px] items-center">
        <div>
          ...
          <p className="leading-loose max-w-md mt-4">
            Stay on top of your job search. Keep track of your job applications, interviews and
            unfortunate rejections, if there's any, and get ready for the next career step.
          </p>
